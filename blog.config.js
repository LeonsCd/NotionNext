...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '36057e5ff43e434ca81205846b0137e0,en:36057e5ff43e434ca81205846b0137e0',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Leon', // 您的昵称 例如 yangliang1007
  BIO: process.env.NEXT_PUBLIC_BIO || '洞穴中的囚徒只能看到墙上的影子，而影子并不是现实的全部。只有走出洞穴，才能看到真正的世界', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-e0s7m7o5n-dawns-projects-8e91a603.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'notion,blog,博客,leon,杨亮,杨晨曦,next,靓仔,亮仔', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '420407904@qq.com', // 邮箱地址 例如mail@tangly1024.com
